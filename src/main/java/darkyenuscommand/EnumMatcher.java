...
public final class EnumMatcher<E extends Enum<E>> {
	...
	/** Computes Levenshtein distance of two strings. (Minimum number of single character modifications needed to get second string
	 * from first) Author: Meta @ vidasConcurrentes
	 *
	...
	/*
	 * Author: Meta @ vidasConcurrentes Related to:
	 * http://vidasconcurrentes.blogspot.com/2011/06/distancia-de-levenshtein-distancia-de.html
	 * 
	 * This is the class which implements the Weighted Levenshtein Distance To do so, we take the base algorithm and make some
	 * modifications, as follows: · multiply first column for the Delete weight · multiply first row for the Insert weight · add
	 * the Delete weight when checking for the [i-1][j] value · add the Insert weight when checking for the [i][j-1] value · make
	 * the substitution cost the Substitution weight
	 */
