	...
	public boolean onCommand (CommandSender sender, Command command, String label, String[] args) {
		try {
			if (command.getName().equals("rules")) {
				...
				sender.sendMessage(ChatColor.BLUE+"Free Space: "+ChatColor.WHITE+formatBytes(freeSpace)+" ("+(int)Math.round((double)(totalSpace - freeSpace)*100.0/(double)totalSpace)+"% of total used)");
