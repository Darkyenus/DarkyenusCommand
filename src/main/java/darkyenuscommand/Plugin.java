...
public class Plugin extends JavaPlugin {
            ...
            if (command.getName().equals("rules")) {
                ...
                if (playerOff != null) {
                    ...
                    if (toKick != null) {
                        ...
                        sender.sendMessage(ChatColor.GREEN.toString() + toKick.getName() + " has been kicked for " + kickTimeMin + " minutes.");
                    } else {
                ...
                if (messageB.length() != 0) {
                    ...
                    getServer().broadcastMessage(ChatColor.DARK_PURPLE + sayAs + ChatColor.GRAY + ": " + ChatColor.DARK_GREEN + message);
                } else {
                    return false;
                }
                //--------------------------------------- SAY END
                ...
                if (sender instanceof Player) {
                    ...
                    for (Entity entity : player.getNearbyEntities(50, 100, 50)) {
                        if (entity instanceof Player && !entity.equals(player)) {
                            Player panicking = (Player) entity;
                            if (!panicking.hasPermission("darkyenuscommand.donotpanic")) {
                                panicking.setMetadata("locked", new FixedMetadataValue(this, true));
                                panicPlayers.put(panicking.getName(), System.currentTimeMillis() + timeToPanic * 60000);
                                added++;
                            }
                        }
                    }
                    ...
                    if (added != 0) {
                        sender.sendMessage(ChatColor.GREEN + "You have locked " + added + "players for " + timeToPanic + " minutes.");
                        unPanicker.notify();
                    } else {
                        sender.sendMessage(ChatColor.RED + "Nobody to panic in range.");
                    }*/
                } else {
                ...
                if (!args[0].startsWith("-") || !sender.hasPermission("darkyenuscommand.command.report.view")) {
                    ...
                    if (messageB.length() != 0) {
                        ...
                        getServer().broadcast(ChatColor.BLUE + "New report from " + sender.getName() + " added!", "darkyenuscommand.command.report.view");
                    } else {
                        return false;
                    }
                } else {
                    if (data.reports.size() == 0) {
                        ...
                        if ("-read".equalsIgnoreCase(args[0])) {
                            sender.sendMessage(ChatColor.BLUE.toString() + index + ")" + ChatColor.ITALIC.toString() + data.reports.get(index));
                ...
                sender.sendMessage(ChatColor.RED.toString() + ChatColor.BOLD.toString() + getInfo.getName() + ChatColor.BLUE + "'s info");
                sender.sendMessage(ChatColor.RED + "Online: " + ChatColor.BLUE.toString() + getInfo.isOnline());
                sender.sendMessage(ChatColor.RED + "Op: " + ChatColor.BLUE.toString() + getInfo.isOp() + ChatColor.RED + " Whitelisted: " + ChatColor.BLUE.toString() + getInfo.isWhitelisted()+ChatColor.RED + " Banned: " + ChatColor.BLUE.toString() + getInfo.isBanned());
                if (getInfo instanceof Player) {
                    Player player = (Player) getInfo;
                    sender.sendMessage(ChatColor.RED + "Position: " + ChatColor.BLUE.toString() + player.getLocation().getWorld().getName()+" "+player.getLocation().getBlockX()+" "+player.getLocation().getBlockY()+" "+player.getLocation().getBlockZ());
                    sender.sendMessage(ChatColor.RED + "Health: " + ChatColor.BLUE.toString() + (((float) player.getHealth()) / 2) + "/"+(float)player.getMaxHealth());
                    if(player.getFireTicks() >= 0)sender.sendMessage(ChatColor.RED + "Fire Ticks: " + ChatColor.BLUE.toString() + player.getFireTicks());
                    if(player.getLastDamageCause() != null && player.getLastDamageCause().getCause() != null)sender.sendMessage(ChatColor.RED + "Last Damage: " + ChatColor.BLUE.toString() + player.getLastDamage() +" from "+player.getLastDamageCause().getCause().toString().toLowerCase().replace("_"," "));
                    sender.sendMessage(ChatColor.RED + "Food: " + ChatColor.BLUE.toString() + (((float) player.getFoodLevel()) / 2) + "/10");
                    ...
                    sender.sendMessage(ChatColor.RED + "Experience: " + ChatColor.BLUE.toString() + player.getTotalExperience() + " - " + (int) (player.getExp() * 100.0) + "%");
                    sender.sendMessage(ChatColor.RED + "Locked: " + ChatColor.BLUE.toString() + player.hasMetadata("locked"));
                    sender.sendMessage(ChatColor.RED + "Walk Speed: " + ChatColor.BLUE.toString() + player.getWalkSpeed() + ChatColor.RED + " Fly Speed: " + ChatColor.BLUE.toString() + player.getFlySpeed());
                    if (player.isOnline()) {
                        sender.sendMessage(ChatColor.RED + "IP: " + ChatColor.BLUE.toString() + player.getAddress().getAddress().getHostAddress());
                    }
                }
                //--------------------------------------- PLAYERINFO END
                return true;
                ...
                if(args.length >= 3){
                    ...
                    if(player == null){
                        ...
                        int[] source = new int[]{player.getLocation().getBlockX(),player.getLocation().getBlockY(),player.getLocation().getBlockZ()};
                ...
                //--------------------------------------- DARKYENUSCOMMAND
                if (args.length != 0 && "reload".equalsIgnoreCase(args[0]) && sender.hasPermission("darkyenuscommand.command.darkyenuscommand")) {
                    onDisable();
                    onEnable();
                    sender.sendMessage(ChatColor.GREEN + "Plugin reloaded!");
                }else if (args.length != 0 && "gc".equalsIgnoreCase(args[0]) && sender.hasPermission("darkyenuscommand.command.darkyenuscommand")) {
                    System.gc();
                } else {
                    sender.sendMessage(ChatColor.GOLD.toString() + ChatColor.BOLD + "Darkyenus Command " + getDescription().getVersion());
                ...
                if (args.length == 0) {
                    if(beHonest){
                        ...
                        for (org.bukkit.plugin.Plugin plugin : getServer().getPluginManager().getPlugins()) {
                            sender.sendMessage(ChatColor.YELLOW + "  " + plugin.getDescription().getName() + " " + ChatColor.ITALIC + plugin.getDescription().getVersion());
                        }
                        ...
                        sender.sendMessage(ChatColor.BLUE + "Availaible Commands: " + ChatColor.YELLOW + ChatColor.ITALIC + String.join(", ", availableCommands));
                    }
                } else {
                    ...
                    if (pluginOfThatName != null) {
                        outputDone = true;
                        sender.sendMessage(ChatColor.BLUE + "Plugin: " + ChatColor.BOLD + pluginOfThatName.getDescription().getName() + " " + ChatColor.ITALIC + pluginOfThatName.getDescription().getVersion());
                        if(args.length > 1 || pluginOfThatName.getDescription().getCommands().size() <= 5){
                            ...
                            sender.sendMessage(ChatColor.BLUE + " Commands: " + ChatColor.YELLOW + ChatColor.ITALIC + String.join(", ", strings));
                            return true;
                        }else if(!pluginOfThatName.getDescription().getCommands().isEmpty()){
                            sender.sendMessage(ChatColor.BLUE.toString() + ChatColor.ITALIC + "Use command \"/command " + pluginOfThatName.getDescription().getName() + " list\" to see list of "+pluginOfThatName.getDescription().getCommands().size()+" commands this plugin has.");
                        }
                    }
                    ...
                    if (commandOfThatName != null && (beHonest || commandOfThatName.testPermissionSilent(sender))) {
                        outputDone = true;
                        sender.sendMessage(ChatColor.BLUE + "Command: " + ChatColor.BOLD + commandOfThatName.getName() + ChatColor.RESET + ChatColor.BLUE.toString() + ChatColor.ITALIC + " (of plugin " + commandOfThatName.getPlugin().getDescription().getName() + ")");
                        sender.sendMessage(ChatColor.BLUE + "  Aliases: " + ChatColor.YELLOW + String.join(", ", commandOfThatName.getAliases()));
                        ...
                        sender.sendMessage(ChatColor.BLUE.toString() + ChatColor.ITALIC + (commandOfThatName.testPermissionSilent(sender) ? "You "+ChatColor.GREEN+"can"+ChatColor.BLUE.toString() + ChatColor.ITALIC+" perform this command." : "You "+ChatColor.RED+"can't"+ChatColor.BLUE.toString() + ChatColor.ITALIC+" perform this command."));
                    }
                ...
                getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " set time in " + world.getName() + " to " + timeToSet + "]", "darkyenuscommand.staff");
                //--------------------------------------- TIME END
                return true;
                ...
                if (timeStopped) {
                    if (world.getTime() != timeToSet) {//Should it be updated?
                        ...
                        getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " updated time to maintain in " + world.getName() + " to " + timeToSet + "]", "darkyenuscommand.staff");
                    } else {//No, it should be removed.
                        world.setGameRuleValue(TIME_KEEP_GAMERULE, "true");
                        getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " cancelled time maintain in " + world.getName() + "]", "darkyenuscommand.staff");
                    }
                } else {
                    world.setGameRuleValue(TIME_KEEP_GAMERULE, "false");
                    getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " set time to maintain in " + world.getName() + " to " + timeToSet + "]", "darkyenuscommand.staff");
                }
                world.setTime(timeToSet);
                //--------------------------------------- TIMEMAINTAIN END
                return true;
                ...
                if (args[0].toLowerCase().startsWith("sun") || args[0].toLowerCase().startsWith("c")) {
                    ...
                    getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " set weather in " + world.getName() + " to clear]", "darkyenuscommand.staff");
                } else if (args[0].toLowerCase().startsWith("storm") || args[0].toLowerCase().startsWith("rain") || args[0].toLowerCase().startsWith("snow")) {
                    world.setStorm(true);
                    world.setThundering(false);
                    world.setWeatherDuration(Integer.MAX_VALUE);
                    getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " set weather in " + world.getName() + " to rainy]", "darkyenuscommand.staff");
                } else if (args[0].toLowerCase().startsWith("thunder") || args[0].toLowerCase().startsWith("light") || args[0].toLowerCase().startsWith("rage")) {
                    world.setStorm(true);
                    world.setThundering(true);
                    world.setWeatherDuration(Integer.MAX_VALUE);
                    world.setThunderDuration(Integer.MAX_VALUE);
                    getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " set weather in " + world.getName() + " to thunder]", "darkyenuscommand.staff");
                ...
                sender.sendMessage(ChatColor.GRAY.toString() + ChatColor.ITALIC + "Gamemode of " + toSet.getName() + " set to " + gameMode.toString());
                //--------------------------------------- GAMEMODE END
                return true;
                ...
                if (args.length != 0) {
                    ...
                    if (amount >= 1 && data >= 0) {
                        ...
                        if(toGive != null){
                            ...
                            sender.sendMessage(ChatColor.GRAY.toString() + ChatColor.ITALIC + toSet.getName() + " was given " + amount + " " + toGive.getType().toString().toLowerCase());
                        }else{
                ...
                if(player.getItemInHand().getType().getMaxDurability() != 0){
                    ...
                    sender.sendMessage(ChatColor.GRAY.toString() + ChatColor.ITALIC + player.getName() + "'s " + itemStackToFix.getType().toString().toLowerCase() + " has been repaired.");
                }else{
                    sender.sendMessage(ChatColor.RED.toString()+player.getItemInHand().getType().toString().toLowerCase() + " is not repairable.");
                }
                //--------------------------------------- REPAIR END
                return true;
                ...
                if ("item".equalsIgnoreCase(args[0]) || "single".equalsIgnoreCase(args[0])) {
                    ...
                    sender.sendMessage(ChatColor.GRAY.toString() + ChatColor.ITALIC + player.getName() + "'s inventory including armor trashed.");
                ...
                if (args.length == 0) {
                    sender.sendMessage(ChatColor.BLUE + "Difficulty of world " + world.getName() + " is " + world.getDifficulty().toString().toLowerCase());
                    return false;//They may want manual
                }
                ...
                getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " set difficulty in " + world.getName() + " to " + difficulty.toString().toLowerCase() + "]", "darkyenuscommand.staff");
                //--------------------------------------- DIFFICULTY END
                return true;
                ...
                getServer().broadcast(ChatColor.GRAY.toString() + ChatColor.ITALIC + "[" + sender.getName() + " removed " + trashed + " entities from world " + world.getName() + "]", "darkyenuscommand.staff");
                //--------------------------------------- CLEAR END
                return true;
                ...
                if (((Player) sender).getWorld().setSpawnLocation(((Player) sender).getLocation().getBlockX(), ((Player) sender).getLocation().getBlockY(), ((Player) sender).getLocation().getBlockZ())) {
                ...
                try {
                    if (!args[0].toLowerCase().startsWith("l")) {//List
                        ...
                        if (worlds.isEmpty()) {
                            sender.sendMessage(ChatColor.BLUE + "Availaible worlds: <none>");//WTF why that would ever happen? But still, its prettier that way.
                        } else {
                            sender.sendMessage(ChatColor.BLUE + "Availaible worlds:");
                            for (World world : worlds) {
                                sender.sendMessage(ChatColor.BLUE + world.getName() + ": " + ChatColor.WHITE + " " + world.getEnvironment().toString() + " | " + world.getWorldType().getName() + " | Players: " + world.getPlayers().size());
                            }
                        }
                    }
                } catch (Exception e) {
                ...
                if(args.length != 0){
                    ...
                    if(player == null && biome == null && entity == null){
                        ...
                        if(matches != 1){
                            ...
                            if(entity != null)matches++;
                            if(matches != 1){
                                sender.sendMessage(ChatColor.RED+"\""+args[0]+"\" does match too many things, please specify what are you looking for.");
                                return true;
                            }
                        }
                        ...
                        if(player != null){
                            ...
                            if(sender instanceof Player){
                                ...
                                if(foundEntities.size() == 0){
                                    ...
                                    for(Entity foundEntity = foundEntitiesIterator.next();foundEntitiesIterator.hasNext();foundEntity = foundEntitiesIterator.next()){
                        ...
                        if(foundAt != null){
                            sender.sendMessage(ChatColor.BLUE.toString()+ChatColor.ITALIC+"X: "+foundAt.getBlockX()+" Y: "+foundAt.getBlockY()+" Z: "+foundAt.getBlockZ());
                            if(sender instanceof Player){
                                Location senderLocation = ((Player) sender).getLocation();
                                sender.sendMessage(ChatColor.BLUE.toString()+ChatColor.ITALIC+String.format("Distance: %.2f",foundAt.distance(senderLocation)));
                ...
                if(args.length > 0){
                    try {
                        ...
                        sender.sendMessage(ChatColor.GREEN.toString()+changedBlocks+" columns had their biome changed. "+ChatColor.ITALIC+"Note: You may have to relog to see changes.");
                        return true;
                    }catch(NumberFormatException ignored){
                        return false;
    ...
    private boolean isGoodTeleportLocation(World world,int x,int y,int z){
        return world.getBlockAt(x,y-1,z).getType().isSolid() && (y == world.getMaxHeight() || (!world.getBlockAt(x,y,z).getType().isSolid() && !world.getBlockAt(x, y + 1, z).getType().isSolid()));
    }
    ...
    private OfflinePlayer matchPlayer(String from) {
        return Util.findNearest(Arrays.asList(getServer().getOfflinePlayers()), offPlayer -> offPlayer.getName().toLowerCase(), from.toLowerCase(), 3);
    }
    ...
    private void onPanicCommand(CommandSender sender,Collection<Player> players,int minutes){
        if(players.size() == 0){
            ...
            for(Player playerToLock:players){
                ...
                playerToLock.sendMessage(ChatColor.BLUE.toString()+ChatColor.BOLD+"You have been locked for "+minutes+" minutes. Do not panic, server admin is probably dealing with problems and will unlock you shortly.");
            }
            sender.sendMessage(ChatColor.BLUE.toString()+players.size()+" players locked for "+minutes+" minutes. Use /depanic to unlock them all.");
        }
    }
